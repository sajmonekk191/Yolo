  ...
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-gray-600">Vítejte zpět, {{ authStore.userName }}!</p>
      </div>
    ...
    <div v-else class="space-y-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Celkový zůstatek -->
        <div class="card bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-blue-100 text-sm font-medium">Celkový zůstatek</p>
              <p class="text-2xl font-bold">{{ formatCurrency(financeStore.stats.balance) }}</p>
            </div>
        ...
        <div class="card">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-gray-600 text-sm font-medium">Měsíční příjmy</p>
              <p class="text-2xl font-bold text-green-600">{{ formatCurrency(financeStore.stats.monthlyIncome) }}</p>
            </div>
        ...
        <div class="card">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-gray-600 text-sm font-medium">Měsíční výdaje</p>
              <p class="text-2xl font-bold text-red-600">{{ formatCurrency(financeStore.stats.monthlyExpenses) }}</p>
            </div>
        ...
        <div class="card">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-2xl font-bold text-purple-600">{{ financeStore.activeGoals.length }}</p>
            </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <!-- Měsíční trend -->
        <div class="card">
          <h3 class="text-lg font-semibold text-gray-900 mb-4">Měsíční trend</h3>
          <div class="h-64 flex items-center justify-center bg-gray-50 rounded-lg">
            <div class="text-center text-gray-500">
              <BarChart3 class="w-12 h-12 mx-auto mb-2" />
              <p>Graf bude implementován</p>
              <p class="text-sm">pomocí Chart.js</p>
            </div>
          </div>
        </div>
        ...
        <!-- Kategorie výdajů -->
        <div class="card">
          <h3 class="text-lg font-semibold text-gray-900 mb-4">Kategorie výdajů</h3>
          <div class="h-64 flex items-center justify-center bg-gray-50 rounded-lg">
            <div class="text-center text-gray-500">
              <PieChart class="w-12 h-12 mx-auto mb-2" />
              <p>Koláčový graf</p>
              <p class="text-sm">kategorie výdajů</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="card">
          ...
          <div class="space-y-3">
            <button
              ...
              class="flex items-center space-x-3 w-full p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors"
            >
              <div class="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center">
                <Plus class="w-4 h-4 text-green-600" />
              </div>
              <span class="font-medium text-gray-900">Přidat transakci</span>
            </button>
            <router-link
              to="/cile"
              class="flex items-center space-x-3 w-full p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors"
            >
              ...
              <span class="font-medium text-gray-900">Nový cíl</span>
            </router-link>
            <router-link
              to="/rozpocty"
              class="flex items-center space-x-3 w-full p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors"
            >
              ...
              <span class="font-medium text-gray-900">Nový rozpočet</span>
            </router-link>
          </div>
        </div>
        ...
        <div class="card lg:col-span-2">
          ...
          <div v-if="financeStore.recentTransactions.length === 0" class="text-center py-6 text-gray-500">
            <ArrowUpDown class="w-12 h-12 mx-auto mb-2 text-gray-300" />
      ...
      <div v-if="financeStore.activeGoals.length > 0" class="card">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Pokrok cílů</h3>
        <div class="space-y-4">
          <div
